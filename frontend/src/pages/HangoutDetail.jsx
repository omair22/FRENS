  ...
  return (
    <div style={{ background: '#0a0a0a', minHeight: '100vh', paddingBottom: 120, maxWidth: 448, margin: '0 auto' }}>
      ...
      <div style={{ padding: '56px 20px 32px' }}>
        <button onClick={() => navigate(-1)} style={{ background: 'none', border: 'none', color: '#f5f5f5', cursor: 'pointer', padding: 0, marginBottom: 32 }}>
      ...
      <div style={{ padding: '0 20px 40px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          ...
          <button 
            onClick={() => setToast({ message: "Invite system coming soon!", type: "info" })}
            style={{
